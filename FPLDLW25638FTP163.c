 ...
 * Windows: .\FPLDLW25638FTP163.exe 1 2 3
 * Linux: ./FPLDLW25638FTP163 1 2 3
*/
int main(int argc, char *argv[]) {
    ...
    for (int i = 1; i < argc; i++) {
        ...
        sprintf(test_input_filename, "FPLDLW25638FTP163IN%02d.txt", test_case_number);
        ...
        sprintf(test_output_filename, "FPLDLW25638FTP163OUT%02d.txt", test_case_number);
